/**
 * @description Créer une fonction 'generateTeams' qui génère des objets 'team' dans un tableau.
 * Ces objets doivent avoir comme attributs : 'name' de type string, 'country' de type string, 'subscribers' de type number, 'players' du même type que les objets générés à l'exercice 1.
 ...
 * l'attribut 'players' doit etre un tableau dont la longueur sera determiné par l'argument size que l'on passera à la fonction. Sachant que ce nombre doit etre au minimum de 10.
 */
